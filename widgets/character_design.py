...
class CharacterDesignWidget(QWidget):
  def __init__(self, main_config):
    ...
    button_group = QGroupBox(widget_config['General']['character_design_title'])
    ...
    for button_id, button_text in widget_config['CharacterDesignButton'].items():
      ...
      button.clicked.connect(partial(button_events.open, 'CharacterDesign', main_config, button_id))
